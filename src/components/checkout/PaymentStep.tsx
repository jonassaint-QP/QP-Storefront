...
declare global {
  interface Window {
    // NMI Payment Component (tokenization) surface. See NMI docs and the
    // public tokenization key from the merchant portal. The payment component
    // emits a token (payment_token) to the provided callback.
    NmiPayments?: {
