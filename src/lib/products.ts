...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 'c-85',
    slug: 'spunk-pure-silicone-2oz',
    category: 'blue-dark-anal',
    name: 'SPUNK Pure Silicone 2 oz',
    tagline: 'Pocket-size silkiness for unhurried play.',
    material: 'Silicone-based lubricant',
    description:
      'A compact bottle with a smooth, low-drag feel that stays silky through slow starts and longer moments.',
    specs: [
      '2 fl oz',
      'Silicone-based formula',
      'Long-lasting glide',
  ...
  {
    id: 'c-86',
    slug: 'spunk-pure-silicone-4oz',
    category: 'blue-dark-anal',
    name: 'SPUNK Pure Silicone 4 oz',
    tagline: 'A silky everyday pour with staying power.',
    material: 'Silicone-based lubricant',
    description:
      'A versatile four-ounce bottle with a fluid, cushiony glide for relaxed pacing and fewer interruptions.',
    specs: [
      '4 fl oz',
      'Silicone-based formula',
      'Long-lasting glide',
  ...
  {
    id: 'c-87',
    slug: 'spunk-pure-silicone-8oz',
    category: 'blue-dark-anal',
    name: 'SPUNK Pure Silicone 8 oz',
    tagline: 'Generous volume. Smooth, steady glide.',
    material: 'Silicone-based lubricant',
    description:
      'A generous bottle of silky silicone glide made for lingering touch, deliberate pacing, and an uninterrupted flow.',
    specs: [
      '8 fl oz',
      'Silicone-based formula',
      'Long-lasting glide',
  ...
  {
    id: 'c-88',
    slug: 'spunk-pure-silicone-16oz',
    category: 'blue-dark-anal',
    name: 'SPUNK Pure Silicone 16 oz',
    tagline: 'High-volume silkiness, ready when you are.',
    material: 'Silicone-based lubricant',
    description:
      'A full-size supply with a sleek, persistent glide for extended sessions and plenty of room to follow the moment.',
    specs: [
      '16 fl oz',
      'Silicone-based formula',
      'Long-lasting glide',
  ...
  {
    id: 'c-89',
    slug: 'boy-butter-h2o-8oz-tub',
    category: 'blue-dark-anal',
    name: 'Boy Butter H2O 8 oz tub',
    tagline: 'Plush, scoopable glide in a bedside tub.',
    material: 'Water-based lubricant',
    description:
      'A soft, cushiony water-based glide in a wide-mouth tub, easy to reach for when touch asks for a little more slip.',
    specs: [
      '8 fl oz',
      'Water-based formula',
      'Wide-mouth tub',
